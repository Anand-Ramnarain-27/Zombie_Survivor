...
public class SaveSystem : MonoBehaviour
{
    ...
    public List<MetaProgressionContainer> GetMetaProgressionFromInspector()
    {
        // Simply return the Meta Progression Containers from the Inspector
        return GameManager.instance.metaProgressionManager.metaProgressionContainers;
    }

    public void SaveMetaProgressionToInspector(List<MetaProgressionContainer> metaProgressionContainers)
    {
        // Update the Meta Progression Containers in the GameManager
        GameManager.instance.metaProgressionManager.metaProgressionContainers = metaProgressionContainers;
    }
    public void SaveMetaProgressionToInspector()
    {
        // Save the changes directly to the Inspector
        SaveMetaProgressionToInspector(GameManager.instance.metaProgressionManager.metaProgressionContainers);
    }
